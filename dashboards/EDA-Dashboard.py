...
if is_target_numeric:
    ...
    with tab2:
        ...
        st.caption("Check for class imbalance. Severe imbalance requires special handling (resampling, weighted models).")
        ...
        st.caption("A well-separated distribution indicates that the feature has predictive power for classification.")
        ...
        st.caption("A strong diagonal or strong color variation indicates predictive categorical relationships.")